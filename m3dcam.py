...
CheckPointData = torch.load('results_pysa_resnet50_F/checkpoint')
model = CheckPointData['model']

path_image = "../../../data/ChestX-ray14/images"
val_df_path = "labels/grad-cam_copy.csv"
...
model = medcam.inject(model, output_dir='attention_maps', backend='gcampp', label='best', save_maps=True)
