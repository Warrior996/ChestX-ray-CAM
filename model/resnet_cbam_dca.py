...
model_urls = {
              'dca_cbam_resnet50': 'https://download.pytorch.org/models/resnet50-19c8e357.pth',
...
def ResidualNet(arch, network_type, depth, num_classes, pretrained):
...
def dca_cbam_resnet50(pretrained=False, **kwargs):
    model = ResidualNet('dca_cbam_resnet50', 'ImageNet', 50, 1000, pretrained=pretrained)
    return model
